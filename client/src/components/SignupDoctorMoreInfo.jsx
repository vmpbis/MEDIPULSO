...
const SignupDoctorMoreInfo = ({formData, setFormData, invalidFields,  setInvalidFields}) => {
  ...
  const handleInputChange = (field, value) => {
    ...
    if (isFieldInvalid(field) && value.trim() !== '') {
  ...
  // Update Select All checkbox when clicked
  if (name === 'selectAll') {
    setFormData({
      ...formData,
      selectAll:  checked,
      termsConditions: checked,
      profileStatistcs: checked
    })
  } else {
    // Uncheck the Select All checkbox if any of the individual checkboxes is unchecked
    if (!checked) {
      setFormData({
        ...formData,
        selectAll: false,
      ...
      const allChecked = name === 'termsConditions' && formData.profileStatistcs ||
                         name === 'profileStatistcs' && formData.termsConditions;
      if (allChecked) {
        setFormData({
          ...formData,
          selectAll: true,
  ...
  return (
    <div>
        ...
        <div className='mt-4'>
          ...
          <div className='flex gap-4 items-end'>
            <select 
              //name="countryCode" 
              id='countryCode'
              className='border w-1/2 sm:w-1/3 rounded-sm border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-300 focus:ring-gray-300 hover:border-gray-400 transition duration-300 ease-in-out'
            ...
            >
              ...
              <option data-countrycode="ZW" value="263">Zimbabwe (+263)</option>
                ...
                <input
                  className='rounded-sm pt-3  border w-[65%] mt-2 text-sm border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-300 focus:ring-gray-300 hover:border-gray-400 transition duration-300 ease-in-out'
                  type="text"
                  id='phoneNumber'
          ...
          <p className='text-[0.7rem] mt-2'>Select the prefix appropriate for your country and <span className='font-semibold opacity-80'>enter your mobile phone number (9 DIGITS e.g. 123 456 789) .</span>
            The number provided will be used to contact you only by Medi-Pulse
          </p>
        </div>
      ...
      <div>
        <div className='border-b-[0.5px] flex gap-2 items-center mt-6 mb-4'>
        
          <input
            className='rounded-sm mb-3 border mt-2 text-sm border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-300 focus:ring-gray-300 hover:border-gray-400 transition duration-300 ease-in-out'
            type='checkbox'
            id='selectAll'
            name='selectAll'
          ...
          <label htmlFor='selectAll' className='font-semibold ml-2'>Select all</label> 
        ...
        <div className='flex items-start gap-2 ml-5'>
          <input
            ...
            onChange={handleCheckbox}
          />
          <label htmlFor='termsConditions' className='text-sm ml-2 py-2'>
            I accept 
            <Link>
      ...
      <div className='text-sm ml-5 flex flex-col'>
...
export default SignupDoctorMoreInfo